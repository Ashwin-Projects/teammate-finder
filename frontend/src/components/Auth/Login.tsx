  ...
  return (
    <button
      ...
      style={{
        ...
        gap: '0.5rem',
        background: hov ? tokens.surfaceHover : 'transparent',
        ...
        <div style={{ width: '100%', maxWidth: '320px' }}>
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            <p style={{ fontSize: '0.75rem', color: tokens.textMuted, margin: 0 }}>
              Find and collaborate with teammates.
            </p>
          </div>

          {/* OAuth buttons */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem', marginBottom: '0' }}>
            <SocialBtn icon={<GoogleIcon />} label="Continue with Google" onClick={() => navigate('/signup')} />
            <SocialBtn icon={<GitHubIcon />} label="Continue with GitHub" onClick={() => navigate('/signup')} />
            <SocialBtn icon={<AppleIcon />}  label="Continue with Apple"  onClick={() => navigate('/signup')} />
          </div>
          ...
          {/* Email / password form */}
          <form onSubmit={handleContinue} style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <div>
              <input
                id="email"
                type="email"
            ...
            <button
              ...
              onMouseEnter={e => { if (!loading && email.trim()) e.currentTarget.style.backgroundColor = tokens.blueHover; }}
          ...
          <p style={{ marginTop: '1rem', fontSize: '0.72rem', color: tokens.textMuted, textAlign: 'center' }}>
            ...
            <Link to="/signup" style={{ color: tokens.blue, textDecoration: 'none', fontWeight: 500 }}
          ...
          {step === 'password' && (
            <p style={{ marginTop: '0.375rem', fontSize: '0.6875rem', color: tokens.textDim, textAlign: 'center' }}>
              <button onClick={() => { setStep('email'); setError(''); }} style={{ background: 'none', border: 'none', cursor: 'pointer', color: tokens.textDim, fontSize: '0.6875rem', fontFamily: 'inherit', padding: 0 }}
